...
import (
	...
	"github.com/RokibulHasan7/marketplace-prototype/internal/services/catalog"
	"github.com/RokibulHasan7/marketplace-prototype/internal/services/deployments"
	"github.com/RokibulHasan7/marketplace-prototype/internal/services/projects"
	"github.com/RokibulHasan7/marketplace-prototype/internal/services/users"
...
func RegisterRoutes(r *chi.Mux) {
	...
	r.Route("/api/user/project", func(r chi.Router) {
		r.Post("/", projects.CreateProject)                           // Create a new project
